...
class myPatchEmbed(nn.Module):
    ...
    def __init__(
        ...
        #     nn.GroupNorm(1, hidden_dim*2, eps=1e-6),
        #     nn.GELU(),
        #     nn.Conv2d(hidden_dim*2, hidden_dim*4, kernel_size=3, stride=2, padding=1, bias=False),
        #     nn.GroupNorm(1, hidden_dim*4, eps=1e-6),
        #     nn.GELU(),
        #     nn.Conv2d(hidden_dim*4, embed_dim, kernel_size=3, stride=2, padding=1, bias=False),
        #     nn.GroupNorm(1, embed_dim, eps=1e-6),
        #     nn.GELU(),
        #     nn.Conv2d(embed_dim, embed_dim, kernel_size=1, stride=1, bias=bias),
        # )
...
class vit_models(nn.Module):
    ...
    def __init__(self, img_size=224,  patch_size=16, in_chans=3, num_classes=1000, embed_dim=768, depth=12,
                 ...
                 block_layers = Block,
                 Patch_layer=myPatchEmbed,act_layer=nn.GELU,
