...
if __name__ == '__main__':
    ...
    _, transformerd_feature_map = condgen(batch_feature_map_view1, batch_action_view1)
    ...
    print(decoder)
    gen_img = decoder(batch_feature_map_view1) # discard CLS token from feature maps
