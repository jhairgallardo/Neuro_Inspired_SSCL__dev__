...
parser.add_argument('--episode_batch_size', type=int, default=80) # 80
parser.add_argument('--num_views', type=int, default=4)
parser.add_argument('--with1stclsview', action='store_true', default=False, help='If False, the first view CLS token is not used for classification.')
# Other parameters
parser.add_argument('--workers', type=int, default=32) # 8 for 1 gpu, 48 for 4 gpus
parser.add_argument('--save_dir', type=str, default="output/Pretrained_condgen_AND_enc/run_debug_causal")
