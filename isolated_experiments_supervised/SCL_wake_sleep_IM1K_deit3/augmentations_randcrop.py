...
class Episode_Transformations:
    ...
    def __call__(self, original_image):
        ...
        for i in range(1, self.num_views):
            ...
            #                                                         brightness_range = [1.0, 1.0], #self.brightness_range, 
            #                                                         contrast_range = [1.0, 1.0], #self.contrast_range, 
            #                                                         saturation_range = [1.0, 1.0], #self.saturation_range, 
            #                                                         hue_range = [0.0, 0.0]) #self.hue_range)
            # if jitter_flag:
            ...
            # ## Gaussian Blur
            # elif choice == 1:
            view, action_gaussianblur, blur_flag = self.apply_gaussian_blur(view, p_gaussian_blur = 1.0, #self.p_gaussian_blur, 
                                                                            sigma_range = [0.1,0.1])#self.sigma_range)
            if blur_flag:
