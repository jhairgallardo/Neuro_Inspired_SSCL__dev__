...
class myPatchEmbed(nn.Module):
    ...
    def __init__(
        ...
        self.norm1 = norm_layer([in_chans,self.img_size[0], self.img_size[1]]) if norm_layer else nn.Identity()
        self.proj = nn.Conv2d(in_chans, embed_dim, kernel_size=patch_size, stride=patch_size, bias=bias)
        self.norm2 = norm_layer(embed_dim) if norm_layer else nn.Identity()
