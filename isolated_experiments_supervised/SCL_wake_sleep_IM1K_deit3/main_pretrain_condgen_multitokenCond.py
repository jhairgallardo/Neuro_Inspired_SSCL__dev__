...
from models_deit3_multitokenCond import *
...
parser.add_argument('--aug_n_heads', type=int, default=8)
parser.add_argument('--aug_dim_ff', type=int, default=512)
...
def main():
    ...
    cond_generator = eval(args.condgen_model_name)(img_num_tokens=args.img_num_tokens,
                                                ...
                                                aug_feature_dim = view_encoder.head.weight.shape[1],
