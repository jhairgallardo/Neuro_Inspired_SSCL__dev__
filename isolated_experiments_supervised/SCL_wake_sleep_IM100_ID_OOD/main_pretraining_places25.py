...
# Dataset parameters
parser.add_argument('--data_path', type=str, default='/data/datasets/Places/places25_standard/small_easyformat')
...
parser.add_argument('--save_dir', type=str, default="output/Pretrained_Places25/run_debug")
