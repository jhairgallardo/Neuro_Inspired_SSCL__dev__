...
parser.add_argument('--pretrained_folder', type=str, default='./experiments/iid/230914_121650') # './experiments/non_iid/230914_121806'
parser.add_argument('--pretrained_network', type=str, default='resnet18.pth')
...
def main_worker(args):
    ...
    missing_keys, unexpected_keys = model.load_state_dict(state_dict['state_dict_encoder'], strict=False)
