...
class Wake_Sleep_trainer:
    ...
    def NREM_sleep(self,
        ...
        criterion_instcontrastive = criterions[1]
        ...
        while self.sleep_episode_counter < self.num_episodes_per_sleep:
            ...
            for v in range(self.num_views):
                ...
                with autocast():
                    batch_instfeats, batch_logits = self.semantic_memory(batch_tensors, return_inst=True)
            ...
            for v in range(self.num_views-1):
                loss_inst += criterion_instcontrastive(batch_episodes_instfeats[:,0], batch_episodes_instfeats[:,v+1])
...
def evaluate_semantic_memory(loader,
        ...
        with torch.no_grad():
            for i, (images, targets, _ ) in enumerate(loader):
                ...
                instproj, logits = semantic_memory(embenc, return_inst=True)
