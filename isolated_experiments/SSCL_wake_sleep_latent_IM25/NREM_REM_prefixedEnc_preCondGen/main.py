...
parser.add_argument('--enc_pretrained_file_path', type=str, default='./../Pretraining_Encoder/output/MIRA_IN25_offPRE_viewEnc_encGNprojGN_preclasses@5_pseudoclasses@100_views@12_epochs@100_lr@0.008_wd@1e-6_bs@128_data_class_order0_seed@0/view_encoder_epoch99.pth')
# Generator parameters
parser.add_argument('--condgen_model_name', type=str, default='ConditionalGenerator')
parser.add_argument('--condgen_pretrained_file_path', type=str, default='./../Pretraining_Cond_Generator/output/MIRA_IN25_offPRE_cond_generator_preEncPseudoclasses@100_preclasses@5_views@6_epochs@100_lr@1e-3_wd@1e-2_bs@80_data_class_order0_seed@/cond_generator_epoch99.pth')
