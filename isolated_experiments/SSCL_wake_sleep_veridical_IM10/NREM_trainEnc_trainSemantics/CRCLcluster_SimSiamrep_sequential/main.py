...
from models import *
from loss_functions import CRCL_PCLoss, SimSiamLossViewExpanded
...
parser = argparse.ArgumentParser(description='Semantic Memory training analysis - CRCLcluster_SimSiamrep_sequential')
# Dataset parameters
...
def main():
    ...
    for task_id in range(len(train_tasks)):
        ...
        criterion_sem_learning = CRCL_PCLoss(batch_size=args.episode_batch_size, alpha=args.alpha, device=device).to(device)
        ### NREM Step ####
        ...
        for task_id_aux in range(task_id+1):
            ...
            task_id_val_stats = evaluate_semantic_memory(task_id_val, 
                                                         ...
                                                         predictor_rep,
                                                         semantic_memory, 
                                                         args.num_pseudoclasses, None, device, False, args.num_classes, None)
