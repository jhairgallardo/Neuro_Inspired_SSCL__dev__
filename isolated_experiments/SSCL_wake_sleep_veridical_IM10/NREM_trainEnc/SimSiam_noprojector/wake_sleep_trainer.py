        ...
        while self.sleep_episode_counter < self.num_episodes_per_sleep:
            ...
            for v in range(self.num_views):
                ...
                with autocast():
                    ...
                    batch_predictions = predictor_rep(batch_tensors)
                    batch_tensors_pooled = batch_tensors.mean(dim=(2,3))
                    batch_targets = predictor_rep.module.norm_noaffine(batch_tensors_pooled)
