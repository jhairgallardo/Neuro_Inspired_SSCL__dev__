...
if zca_scale_filter:
    ...
    # scale down gray low frequency filters
    ...
    # scale down gray mid frequency filters
    aux_conv0 = torch.nn.Conv2d(3, weight_gray_mf.shape[0], kernel_size=conv0_kernel_size, stride=1, padding='same', padding_mode='replicate', bias=False)
