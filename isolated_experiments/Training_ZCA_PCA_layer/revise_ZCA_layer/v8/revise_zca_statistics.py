...
def scaled_filters(zca_layer, imgs, save_dir=None, prob_threshold=0.99999):
...
plot_channel_cov(conv0, zca_input_imgs, name='zcainput_channelcov_zca_raw_out', save_dir=save_dir)
plot_zca_layer_output_hist(conv0, zca_input_imgs, name='zcainput_zca_raw_out_hist', save_dir=save_dir)
...
plot_filters_and_hist(conv0.weight, name='zca_filters_multiplier', save_dir=save_dir)
plot_channel_cov(conv0, zca_input_imgs, name='zcainput_channelcov_zca_multiplier_out', save_dir=save_dir)
plot_zca_layer_output_hist(conv0, zca_input_imgs, name='zcainput_zca_out_multiplier_hist', save_dir=save_dir)

### Add negative filters
if conv0_outchannels>=6:
