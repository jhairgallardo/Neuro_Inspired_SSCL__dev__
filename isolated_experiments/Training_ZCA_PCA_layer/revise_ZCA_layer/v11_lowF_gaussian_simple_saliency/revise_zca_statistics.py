...
# plot_filters_and_hist(weight_lf, name='zca_lowF_filters_resize', save_dir=save_dir)

# weight_lf = F.interpolate(weight, size=conv0_kernel_size + 14, mode='bilinear', align_corners=True) # for kernel 7x7 (+14 7:-7) for kernel 5x5 (+4 2:-2)
# weight_lf = weight_lf[:,:,7:-7,7:-7]
# plot_filters_and_hist(weight_lf, name='zca_lowF_filters_resize', save_dir=save_dir)

## Instead of increasing size and cropping center, less convolve a gaussian kernel against the high frequency filters to generate the low frequency filters
...
plot_filters_and_hist(weight_lf, name='zca_lowF_filters_gaussian', save_dir=save_dir)
