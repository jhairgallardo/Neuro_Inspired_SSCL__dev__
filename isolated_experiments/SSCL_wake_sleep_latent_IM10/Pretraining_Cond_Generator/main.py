...
parser.add_argument('--num_pretraining_classes', type=int, default=2)
        ...
        for i, (batch_episode, _, _) in enumerate(train_loader):
            ...
            for v in range(args.num_views):
                ...
                with autocast():
                    ...
                    batch_gen_images, batch_gen_FTtensors = cond_generator(batch_first_view_tensors, batch_actions, return_transformed_feature_map=True)
                    batch_gen_DecEnctensors = view_encoder(batch_gen_images)

                    # Uncoditional forward pass
                    batch_gen_images_direct = cond_generator(batch_tensors, None, unconditional_mode=True)
        ...
        if (epoch+1) % 5 == 0 or epoch==0:
            ...
            with torch.no_grad():
                ...
                for v in range(args.num_views):
                    ...
                    gen_images = cond_generator(first_view_tensors, actions, return_transformed_feature_map=False)
