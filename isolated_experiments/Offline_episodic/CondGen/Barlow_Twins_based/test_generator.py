...
# from models_encBNMish_CondGen import *
from models_encGNMish_ftrelu_genGNMish import *
from augmentations_test import Episode_Transformations
...
parser.add_argument('--enc_pretrained_file_path', type=str, default='./../../Encoder/Barlow_Twins/output/IM10_offPRE_encGNMishprojBNReLU_views@6_epochs@100_lr@0.003_wd@0_bs@192_koleo@0_seed@0/view_encoder_epoch99.pth')
...
def main():
    ...
    cond_generator_state_dict = torch.load('/home/jhair/Research/DOING/Neuro_Inspired_SSCL__dev__/isolated_experiments/Offline_episodic/CondGen/Barlow_Twins_based/output/CondGen_IM10_offPRE_encGNMishIM10_views@2_epochs@100_lr@0.001_wd@0.01_bs@128_seed@0/cond_generator_epoch99.pth')
        ...
        for i, (batch_episode, _) in enumerate(train_loader):
            ...
            if i==0: #only for first batch
                for n_img in range(10):
                    target_tensor = batch_episode_tensors[n_img, 1]
                    ...
                    target_image = batch_episode_imgs[n_img, 1]
                    ...
                    # Save the plot
                    plt.savefig(os.path.join(args.save_dir, f'Comparison_batch_{i+1}_image_{n_img}.png'), bbox_inches='tight')
                    plt.close()
                    ...
                    # Save the plot
                    plt.savefig(os.path.join(args.save_dir, f'Comparison_boxplot_batch_{i+1}_image_{n_img}.png'), bbox_inches='tight')
                    plt.close()
                    ...
                    plt.savefig(os.path.join(args.save_dir, f'Heatmap_batch_{i+1}_image_{n_img}.png'), bbox_inches='tight')
                    plt.close()
                    ...
                    plt.axis('off')
                    # Save the plot
                    plt.savefig(os.path.join(args.save_dir, f'Image_batch_{i+1}_image_{n_img}.png'), bbox_inches='tight')
                    plt.close()
