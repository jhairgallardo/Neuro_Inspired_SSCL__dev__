...
parser.add_argument('--enc_pretrained_file_path', type=str, default='./../../Encoder/Barlow_Twins/output/IM5rand_offPRE_encprojBNMish_views@6_epochs@100_lr@0.003_wd@0_bs@128_koleo@0_seed@0/view_encoder_epoch99.pth')
...
def main():
    ...
    cond_generator_state_dict = torch.load('/home/jhair/Research/DOING/Neuro_Inspired_SSCL__dev__/isolated_experiments/Offline_episodic/CondGen/Barlow_Twins_based/output/CondGen_IM5rand_offPRE_encBNMishIM5rand_views@6_epochs@100_lr@0.001_wd@0.01_bs@80__seed@0/cond_generator_epoch99.pth')
