...
from models_encprojBNMish_zca import *
...
parser = argparse.ArgumentParser(description='View Encoder Pretraining - Barlow Twins ZCA Episodic offline')
# Dataset parameters
...
def main():
    ...
    for epoch in range(args.epochs):
        ...
        view_encoder.train()
        projector_rep.train()
        for i, (batch_episodes_imgs, _) in enumerate(train_loader):

            # Forward pass
            batch_episodes_imgs = batch_episodes_imgs.to(device)
