...
parser.add_argument('--filename', type=str, default='mira-2024-10-15_18-00-43.pth.tar', help='path to pth.tar file')
parser.add_argument('--batch-size', default=1024, type=int)
parser.add_argument('--workers', default=4, type=int, help='per gpu # of workers')
parser.add_argument('--distributed', default=False, type=lambda s: s.lower() in ['true', 't', 'yes', '1'])
parser.add_argument("--local_rank", default=0, type=int, help="Please ignore and do not set this argument.")
parser.add_argument('--data-dir', default='/data/datasets/ImageNet-10', type=str)
...
parser.add_argument('--momentum', default=False, type=lambda s: s.lower() in ['true', 't', 'yes', '1'])
